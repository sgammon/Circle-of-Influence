...
class ProtoHelper(DataManager):
    ...
    def insert(self):
        ...
        self.models.append(self.P(_class=Nation,
        ...
        self.models.append(self.P(_class=State,
                                    direct_parent=db.Key.from_path('Proto','GeoArea'),ancestry_path=['E','GeoArea'],abstract=False,derived=False,is_data=True,poly_model=True,uses_keyname=False,uses_parent=False,uses_id=False,
                                   created_modified=True))
                                   
        self.models.append(self.P(_class=County,
                                    direct_parent=db.Key.from_path('Proto','GeoArea'),ancestry_path=['E','GeoArea'],abstract=False,derived=False,is_data=True,poly_model=True,uses_keyname=False,uses_parent=False,uses_id=False,
                                   created_modified=True))
                                   
        self.models.append(self.P(_class=PostalCode,
                                    direct_parent=db.Key.from_path('Proto','GeoArea'),ancestry_path=['E','GeoArea'],abstract=False,derived=False,is_data=True,poly_model=True,uses_keyname=False,uses_parent=False,uses_id=False,
                                   created_modified=True))
    ...
    def clean(self):
        ...
        self.models.append(self.P.get_by_key_name('Nation'))
        self.models.append(self.P.get_by_key_name('State'))
        self.models.append(self.P.get_by_key_name('County'))
        self.models.append(self.P.get_by_key_name('PostalCode'))
